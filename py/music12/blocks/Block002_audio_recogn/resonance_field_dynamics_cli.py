...
def main() -> None:
    ...
    while frame <= max_frame:
        ...
        if source_pressure > sink_pressure * 1.25 and source_pressure > carrier_pressure:
            field_state = "SOURCE_DOMINANT_FIELD"
        ...
        readable_rows.append({
            ...
            "summary": (
                ...
                f"source={source_pressure:.2f} carrier={carrier_pressure:.2f} "
                f"sink={sink_pressure:.2f} micro={micro_token_richness} "
    ...
    meta = {
        ...
        "ontology_note": (
            ...
            "source/carrier/sink pressures together with micro/coarse topology richness, "
    ...
    txt.extend([
        ...
        "  Musical resonance forms dynamic fields with source pressure,",
        "  carrier pressure, sink pressure and changing acoustic scene state.",
